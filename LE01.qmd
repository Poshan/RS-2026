...
-   Answer (for yourself) the following questions:
    -   [Why is a geographic dataset without coordinate system information ambiguous?]{.smaller}
    -   [What is a equipotential surface?]{.smaller}
    -   [Name one similarity and two differences between latitude and longitude]{.smaller}
    -   [Name four types of datums and their differences]{.smaller}
    -   [Name one similarity and two differences between WGS84 and ITRF]{.smaller}
-   Submit your questions to Learnweb by Wednesday [noon]{.highlight} next week (22.04.2026 12:00:00)